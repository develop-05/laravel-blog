        ...
        <div class="app-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form action="{{route('tags.update', ['tag' => $tag->id])}}" method="POST" class="ajax-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="meta_desc" class="form-control" id="meta_desc" value="{{ $tag->meta_desc }}">
                        </div>
                      </div>
